...
(6, "Zamberlan 8000 Everest EVO RR",  "Buty wyprawowe Zamberlan 8000 Everest EVO RR to model dla prawdziwych profesjonalistów wspinających się na ośmiotysięczniki, którzy oczekują maksymalnego wsparcie od swojego zaawansowanego ekwipunku. Nie inaczej jest w przypadku tej technicznie dopracowanej konstrukcji, która sprawi, że wejście na szczyt będzie lepiej zabezpieczone oraz skutecznie wsparte.", 312000),
(6, "Zamberlan 8000 Everest EVO RR",  "Buty wyprawowe Zamberlan 8000 Everest EVO RR to model dla prawdziwych profesjonalistów wspinających się na ośmiotysięczniki, którzy oczekują maksymalnego wsparcie od swojego zaawansowanego ekwipunku. Nie inaczej jest w przypadku tej technicznie dopracowanej konstrukcji, która sprawi, że wejście na szczyt będzie lepiej zabezpieczone oraz skutecznie wsparte.", 312000),
(6, "Garmont G-Radikal GTX",  "Buty wysokogórskie Garmont G-Radikal GTX to wysoce zaawansowana konstrukcja sprawdzająca się na trudnych szlakach i wymagających skalnych ścianach, gdy przychodzi Ci podejmować się aktywności typu alpejskiego. Zastosowano tutaj szereg rozwiązań mających zapewnić większe bezpieczeństwo w terenie, a jednocześnie wspierać użytkownika tego modelu na kolejnych kilometrach ścieżek lub metrach skalnych występu. Ta konstrukcja sprawdzi się w okresie przejściowym i latem, gdy mimo cieplejszej aury na wyższych partiach gór zalega śnieg.", 152700),
(6, "Garmont G-Radikal GTX",  "Buty wysokogórskie Garmont G-Radikal GTX to wysoce zaawansowana konstrukcja sprawdzająca się na trudnych szlakach i wymagających skalnych ścianach, gdy przychodzi Ci podejmować się aktywności typu alpejskiego. Zastosowano tutaj szereg rozwiązań mających zapewnić większe bezpieczeństwo w terenie, a jednocześnie wspierać użytkownika tego modelu na kolejnych kilometrach ścieżek lub metrach skalnych występu. Ta konstrukcja sprawdzi się w okresie przejściowym i latem, gdy mimo cieplejszej aury na wyższych partiach gór zalega śnieg.", 152700),
(5, "La Sportiva Trango Tower GTX",  "Buty wysokogórskie La Sportiva Trango Tower GTX to propozycja dla wytrawnych miłośników górskich wędrówek. Zapewnią niezbędne wsparcie techniczne na najbardziej wymagających odcinkach szlaków oraz zadbają o wygodę użytkowania i komfort termiczny, gdy wokół zapanuje mroźna zimowa aura.", 135700),

(3, "Plecak turystyczny Gregory Zulu 30",  "Plecak turystyczny Gregory Zulu 30 - empire blue - pozwoli na podejmowanie się krótkich trekkingów lub szybkiego zdobywania szczytu odbywającego się w jeden dzień. Zmieścisz tutaj cały niezbędny ekwipunek, do którego zawsze będziesz miał wygodny dostęp. Gdziekolwiek wybierzesz się z tym modelem to liczyć możesz na maksymalną stabilność oraz komfortowe dopasowanie sprawiające, że pokonywanie kolejnych kilometrów stanie się o wiele łatwiejsze.", 52700),
(3, "Plecak turystyczny Gregory Zulu 30",  "Plecak turystyczny Gregory Zulu 30 - empire blue - pozwoli na podejmowanie się krótkich trekkingów lub szybkiego zdobywania szczytu odbywającego się w jeden dzień. Zmieścisz tutaj cały niezbędny ekwipunek, do którego zawsze będziesz miał wygodny dostęp. Gdziekolwiek wybierzesz się z tym modelem to liczyć możesz na maksymalną stabilność oraz komfortowe dopasowanie sprawiające, że pokonywanie kolejnych kilometrów stanie się o wiele łatwiejsze.", 53800),
(3, "Plecak turystyczny Gregory Zulu 30",  "Plecak turystyczny Gregory Zulu 30 - empire blue - pozwoli na podejmowanie się krótkich trekkingów lub szybkiego zdobywania szczytu odbywającego się w jeden dzień. Zmieścisz tutaj cały niezbędny ekwipunek, do którego zawsze będziesz miał wygodny dostęp. Gdziekolwiek wybierzesz się z tym modelem to liczyć możesz na maksymalną stabilność oraz komfortowe dopasowanie sprawiające, że pokonywanie kolejnych kilometrów stanie się o wiele łatwiejsze.", 53800),

(1, "Plecak Osprey Kestrel 48",  "Plecak Osprey Kestrel 48 doskonale sprawdzi się na krótszych trekkingach, gdy w góry wybierasz się na kilka dni i chcesz spakować cały niezbędny ekwipunek. Jednak z tego modelu skorzystają także osoby podejmujące się turystyki lodowcowej, gdzie dochodzi konieczność zabierania ze sobą szpeju wspinaczkowego. Wynika to z jego niezwykle stabilnej konstrukcji oraz szeregu szpejarek, w które wepniesz wszego, czego potrzebujesz.", 77000),
